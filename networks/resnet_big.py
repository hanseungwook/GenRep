...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channel=3, img_size=32):
...
class SupConResNet(nn.Module):
    ...
    def __init__(self, name='resnet50', img_size=256, head='mlp', feat_dim=128):
...
class SupCEResNet(nn.Module):
    """encoder + classifier"""
    def __init__(self, name='resnet50', img_size=256, num_classes=10):
